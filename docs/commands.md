...
The library uses the `/api` surface, which works on both tiers. The exceptions
are the raw CAN frames of `AmpioAdminClient` in
[`panel-writes.md`](panel-writes.md). These frames drive binary and
open-collector outputs, the buzzer, the panel colors, the touch lock, identify,
and the cover roller lock.

| Verb                               | Method                                     | Args                        | Notes                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| ---------------------------------- | ------------------------------------------ | --------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `turnOn`                           | `turn_on()`                                | -                           | Full on (255). A binary `flaga` answers it too, and every other input kind is refused. `rgbw` and `ledww` objects ignore it (no effect, no reply) - see `setColors` and `setWWPower`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| `turnOff`                          | `turn_off()`                               | -                           | Off. A binary `flaga` answers it too, and every other input kind is refused. `rgbw` objects ignore it (no effect, no reply) - turn those off with `setColors 0/0/0/0`. A `ledww` ignores it too - turn those off with `setWWPower 0`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| `switch`                           | `switch()`                                 | -                           | Inverts the current state. A binary `flaga` answers it too, and every other input kind is refused. `rgbw` objects ignore it (no effect, no reply). A `ledww` answers it, and it is the one verb of this family that a `ledww` answers: the M-SERV writes `255 - power` and `256 - coldness`, so two calls return the light to where it started.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
