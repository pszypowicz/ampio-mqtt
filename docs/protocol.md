...
| `devices`        | `ampio/control/<user>/data`   | `ampio/fromDB/<user>/data/devices`        | `{List: [...]}` - the object catalogue, served to every account. A standard account sees its app grants. The admin login sees every object in a room plus the two presence rows.                                                                                                                                                                                                                                                                                                        |
