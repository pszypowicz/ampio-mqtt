...
| `open`                             | -                           | Cover to 100.                                                                                                                                                                                                                                                                                                                       |
| `close`                            | -                           | Cover to 0.                                                                                                                                                                                                                                                                                                                         |
| `stop`                             | -                           | Halts a cover: mid-travel the position stream freezes at the halt point and the commanded target is never reached; during the pre-travel slat rotation it cancels the pending move; on a stationary cover it is a silent no-op. Exposed as `stop_cover()`.                                                                          |
