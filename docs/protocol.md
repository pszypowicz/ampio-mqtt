...
| `AmpioClient.last_*_payload`    | Verbatim retained response payloads per keyword (`details`, `devices`, `info`, `groups`, `group_devices`, `locations`). Intended for the HA integration's diagnostics blob.                 |
