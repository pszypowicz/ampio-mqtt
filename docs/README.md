...
| [`lan-discovery.md`](lan-discovery.md)           | What the M-SERV actually publishes over mDNS and DHCP, and why the config flow's unique id comes from probing the broker instead. |
