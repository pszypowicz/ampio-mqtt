...
This module is Home Assistant agnostic; device classes / units are plain strings.
"""
...
# Kept for clarity at call sites; both requests use the shared config topic.
details_request_topic = config_request_topic
